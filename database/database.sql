...
/*DYNAMIC*/
/*
KEY_1 = ID_DEPARTMENT FROM TABLE ID_DEPARMENT
 */
...
/*DYNAMIC*/
/*
KEY_1 = ID_DEPARTMENT FROM TABLE ID_DEPARTMENT
 */
...
/*
KEY_1 = ID_DEPARTMENT FROM TABLE ID_DEPARTMENT
KEY_2 = ID_AREA FROM TABLE DEPARTMENT_AREA_{KEY}
 */
}
...
/*DYNAMIC*/
create table IF NOT EXISTS DEPARTMENT_MODULES_{}(
...
KEY_1 = ID_DEPARTMENT FROM TABLE ID_DEPARTMENT
KEY_2 = ID_AREA FROM TABLE DEPARTMENT_AREA_{KEY}
KEY_3 = ID_AREA FROM TABLE DEPARTMENT_AREA_{KEY}
 */
create table IF NOT EXISTS DEPARTMENT_AREA_MODULE_USER_ACCESS_{}_{}_{}(
	ID_USER tinyint NOT NULL,
	USER_DEPARTMENT_STATUS tinyint(1) NOT NULL DEFAULT 0,
