...
<html>
  ...
  <link href="../resources/bower_components/bootstrap-sweetalert/lib/sweet-alert.css" rel="stylesheet">
  <link href="../resources/bower_components/material-design-iconic-font/dist/css/material-design-iconic-font.min.css" rel="stylesheet">
  <link href="../resources/bower_components/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet">        
  ...
  <body>
          ...
          <ul class="top-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu dm-icon pull-right">
                ...
                <li class="hidden-xs">
                  <a data-action="fullscreen" href=""><i class="zmdi zmdi-fullscreen"></i>Pantall Completa</a>
                </li>
                <li>
                  <a data-action="clear-localstorage" href=""><i class="zmdi zmdi-delete"></i>Limpiar Local Storage</a>
                </li>
                <li>
    ...
    <script src="../resources/bower_components/flot.curvedlines/curvedLines.js"></script>
    <script src="../resources/sparklines/jquery.sparkline.min.js"></script>
    <script src="../resources/bower_components/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
    <script src="../resources/bower_components/moment/min/moment.min.js"></script>
    <script src="../resources/bower_components/fullcalendar/dist/fullcalendar.min.js "></script>
    <script src="../resources/bower_components/simpleWeather/jquery.simpleWeather.min.js"></script>
    <script src="../resources/bower_components/Waves/dist/waves.min.js"></script>
    <script src="../resources/bootstrap-growl/bootstrap-growl.min.js"></script>
    <script src="../resources/bower_components/bootstrap-sweetalert/lib/sweet-alert.min.js"></script>
